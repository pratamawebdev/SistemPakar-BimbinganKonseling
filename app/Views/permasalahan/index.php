        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a type="button" class="btn btn-success" href="<?php echo site_url('permasalahan/create') ?>">
                ...
                <table id="table1" class="table table-striped table-bordered nowrap" style="width:100%">
                    ...
                    <tbody>
                        <?php foreach ($data as $d) : ?>
                            <tr>
                                <td> <?= $d->kode_permasalahan ?> </td>
                                <td> <?= $d->nama_permasalahan ?> </td>
                                <td> <?= substr($d->solusi, 0, 20)  ?> ...</td>
                                <td style='width:15%;'>
                                    <a href="<?= site_url('permasalahan/update/' . $d->kode_permasalahan) ?>" class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
                                    <a onclick="deleteConfirm('<?= site_url('permasalahan/delete/' . $d->kode_permasalahan) ?>')" href="#!" class="btn btn-small text-danger"><i class="fas fa-trash"></i>
                                        Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
