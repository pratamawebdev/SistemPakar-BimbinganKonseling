            ...
            <div class="card-body">
                ...
                <form method="post">
                    <div class="form-group">
                        ...
                        <input class="form-control" maxlength="8" type="text" name="kode_sikap" value="<?= $data->kode_sikap; ?>" placeholder="Kode sikap" required readonly/>
                        <div class="invalid-feedback">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="nama_sikap">Nama Sikap</label>
                        <input class="form-control" type="text" name="nama_sikap" value="<?= $data->nama_sikap ?>" placeholder="Nama sikap" required />
                        <div class="invalid-feedback">
                        </div>
                    </div>
                    <br>
