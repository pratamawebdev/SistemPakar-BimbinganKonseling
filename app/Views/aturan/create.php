            ...
            <div class="card-body">
                ...
                <form method="post">
                    <div class="form-group">
                        ...
                        <input class="form-control" maxlength="8" type="text" name="kode_aturan" value="" placeholder="Kode aturan" oninput="this.value = this.value.toUpperCase()" required />
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="kode_permasalahan" id="kode_permasalahan" required>
                            ...
                            <?php foreach ($permasalahan as $p) : ?>
                                <option value="<?= $p->kode_permasalahan ?>" <?= old('kode_permasalahan') === $p->kode_permasalahan ? 'selected' : '' ?>>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="sikaps[]" id="sikaps" multiple="multiple" required>
                            ...
                            <?php foreach ($sikap as $g) : ?>
                                <option value="<?= $g->kode_sikap ?>" >
